...
class TemplateLoader {
        ...
        return [
    {
        ...
        "options": [
            "case后必须跟整数或字符常量，不能是变量",
            "switch的表达式可以是浮点型（如double）",
            "default分支必须放在所有case最后",
            "case分支后可以不写break，程序会自动终止"
        ],
        "correctAnswer": 0,
    ...
    },
    {
        ...
        "options": [
            "switch只能判断等值条件，if-else可判断范围条件",
            "多分支场景下，switch比if-else更简洁",
            "switch的表达式类型可以是任意类型，if的条件只能是布尔型",
            "switch中case分支需用break终止，否则会\"贯穿\""
        ],
        "correctAnswer": 2,
    ...
    },
    {
        ...
        "correctAnswer": 0,
        "explanation": "循环执行过程：\n1. i=1: result=1*1=1\n2. i=2: result=1*2=2\n3. i=3: result=2*3=6\n4. i=4: result=6*4=24 → 满足result>20 → result=24-4=20 → break退出循环",
        "codeExample": "```c\n#include <stdio.h>\nint main() {\n    int i, result = 1;\n    for(i = 1; i <= 5; i++) {\n        result *= i;\n        if(result > 20) {\n            result -= i;\n            break;\n        }\n    }\n    printf(\"最终result=%d\", result);\n    return 0;\n}\n// 输出：20\n```"
    }
]
    }
